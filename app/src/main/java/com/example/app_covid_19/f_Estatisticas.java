...
public class f_Estatisticas extends Fragment {
    ...
    public void menuPrincipal(){
        NavController navController = NavHostFragment.findNavController(f_Estatisticas.this);
        navController.navigate(R.id.action_fragment_historico_to_fragment_menu_principal);
    }
}